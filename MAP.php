    ...
    <li class="nav-item ">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        ...
        <li class="nav-item">
        <a class="nav-link active" href="http://localhost/inaayat/map.php">Map<span class="sr-only">(current)</span></a>
      </li>
 ...
 echo "<p> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
    ...
    <div class="card-group">
      <div class="card">
        ...
        <div class="card-body">
          <h5 class="card-title">Inaayat Refreshers</h5>
          <p class="card-text">No.19 Community Centre Market<br>New Friends Colony, Block A, New Delhi <br>Delhi-110025<br>1800110075, 01124352435, 01124312431<br>info@inaayat.com<br>Mon-Sun: 10:00 am - 10:00 pm</p>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <h5 class="card-title">Inaayat Sunshine</h5>
          <p class="card-text">Shop No. F-17, near Metro Pillar No. 54<br>Vikas Marg, Laxmi Nagar, New Delhi <br>Delhi-110092<br>1800110075, 01124352435, 01124312431<br>info@inaayat.com<br>Mon-Sun: 10:00 am - 10:00 pm</p>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <h5 class="card-title">Inaayat Fiesta</h5>
          <p class="card-text">C - 67, Okhla Industrial Area<br>Phase 1, New Delhi <br>Delhi-110201<br>1800110075, 01124352435, 01124312431<br>info@inaayat.com<br>Mon-Sun: 10:00 am - 10:00 pm</p>
        </div>
      </div>
      <div class="card">
        <img class="card-img-top" src="pic4.jpg" alt="Card image cap">
        <div class="card-body">
          <h5 class="card-title">Inaayat Ocean-view</h5>
          <p class="card-text">2, Main Market <br>Sunder Nagar, New Delhi <br>Delhi-110003<br>1800110075, 01124352435, 01124312431<br>info@inaayat.com<br>Mon-Sun: 10:00 am - 10:00 pm</p>
